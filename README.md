...
1. Install Vagrant on your OS.

2. Install Azure plugin for Vagrant : vagrant plugin install azure
...
3. vagrant init 
	Will create a Vagrantfile with only comments. You should edit this file afterwards.
4. Edit your Vagrantfile 
	With the different fields you need. It should look like the one in this link :
...
8. If any of these points fail, the best way to solve the problem is surely to restart on a fresh VM. To do that, keep a copy in your Vagrantfile somewhere (in a Vagrantfile-old for example) and launch the following script:
